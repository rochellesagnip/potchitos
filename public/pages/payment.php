...
<body>
    ...
    <div class="container">
    <h1 class="h3 mt-4 mb-5">Payment</h1>
    <div class="row">
      <!-- Left -->
      <div class="col-lg-9">
  ...
  <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
    <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapseGCash" aria-expanded="false">
    ...
    <span>
      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/GCash_logo.svg/1920px-GCash_logo.svg.png?20230830061433" alt="GCash Logo" width="50">
    </span>
  </h2>
  <div id="collapseGCash" class="accordion-collapse collapse" data-bs-parent="#accordionPayment">
    <div class="accordion-body">
      <div class="px-2 col-lg-6 mb-3">
        <label class="form-label">GCash Mobile Number</label>
        <input type="text" class="form-control" placeholder="09XX-XXXX-XXX">
      </div>
      <div class="px-2 col-lg-6 mb-3">
        <label class="form-label">Amount</label>
        <input type="text" class="form-control" value="$224.50" readonly>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="card position-sticky top-0">
    <div class="p-3 bg-light bg-opacity-10">
      ...
      <div class="d-flex justify-content-between mb-1 small">
        <span>Subtotal</span> <span>P214.50</span>
      </div>
      <div class="d-flex justify-content-between mb-1 small">
        <span>Shipping</span> <span>P20.00</span>
      </div>
  
      <hr>
      <div class="d-flex justify-content-between mb-4 small">
        <span>TOTAL</span> <strong class="text-dark">P224.50</strong>
      </div>
      ...
      <input class="form-check-input" type="checkbox" value="" id="tnc">
        ...
        <label class="form-check-label" for="subscribe">
          You can only cancel your order within 24 hours.
        </label>
      </div>
      <button class="btn btn-primary w-100 mt-2">Place order</button>
      <a href="cart.php" class="btn btn-outline-secondary w-100 mt-3">Return to Cart</a>
    </div>
  </div>
</div>
